      ...
      <div className="treatments">
        ...
        >
          ...
          <div className="treatment-info">
            ...
            <h6>
              ...
              vampire treatment, we can stimulate collagen production so that
              cell renewal occurs faster. PRP on the skin can be performed on
              the face, neck, decolletage or on the hands.
            </h6>
            <br />
        ...
        >
          ...
          <div className="treatment-info">
            ...
            <h6>
              ...
              trying other types of treatments. Laser and light therapy might
              not be right for every person. “Normally, a person will try other
        ...
        >
          ...
          <div className="treatment-info">
            ...
            <h6>
              ...
              hormones, and plant extracts to rejuvenate and tighten skin, as
              well as remove excess fat. Michel Pistor, a doctor in France,
              developed the technique in 1952. It was originally used to relieve
              pain. In the years since, it has gained popularity in the United
        ...
        >
          ...
          <div className="treatment-info">
            ...
            <h6>
              Plasma Pen is a technique that uses injections of vitamins,
              enzymes, hormones, and plant extracts to rejuvenate and tighten
              skin, as well as remove excess fat. Michel Pistor, a doctor in
              France, developed the technique in 1952. It was originally used to
              relieve pain. In the years since, it has gained popularity in the
